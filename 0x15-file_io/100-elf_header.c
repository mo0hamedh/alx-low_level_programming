...
/**
 * print_magic - a prints the magic numbers of the ELF file
 ...
 * @e_ident: a pointer to an array of bytes specifie
 * Return: nothing
*/
...
/**
 * print_entry - to prints the entry point of an ELF file
...
/**
 * close_file - to close the ELF file
